...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Add a New Author') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('admin.author.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" id="about_author" rows="6" style="resize: none" maxlength="5000" name="about_author"></textarea>
                            </div>
                        </div>
